...
def file_based_input_fn_builder(
  ...
  name_to_features = {
      "input_ids0": tf.io.FixedLenFeature([seq_length], tf.int64),
      "input_mask0": tf.io.FixedLenFeature([seq_length], tf.int64),
      "segment_ids0": tf.io.FixedLenFeature([seq_length], tf.int64),
      "input_ids1": tf.io.FixedLenFeature([seq_length], tf.int64),
      "input_mask1": tf.io.FixedLenFeature([seq_length], tf.int64),
      "segment_ids1": tf.io.FixedLenFeature([seq_length], tf.int64),
      "input_ids2": tf.io.FixedLenFeature([seq_length], tf.int64),
      "input_mask2": tf.io.FixedLenFeature([seq_length], tf.int64),
      "segment_ids2": tf.io.FixedLenFeature([seq_length], tf.int64),
      "input_ids3": tf.io.FixedLenFeature([seq_length], tf.int64),
      "input_mask3": tf.io.FixedLenFeature([seq_length], tf.int64),
      "segment_ids3": tf.io.FixedLenFeature([seq_length], tf.int64),
      "input_ids4": tf.io.FixedLenFeature([seq_length], tf.int64),
      "input_mask4": tf.io.FixedLenFeature([seq_length], tf.int64),
      "segment_ids4": tf.io.FixedLenFeature([seq_length], tf.int64),
...
def main(_):
  ...
  if FLAGS.do_predict:
    ...
    test_predictions_file = os.path.join(
      FLAGS.output_dir,
      "test_results.csv")
    with tf.io.gfile.GFile(test_predictions_file, "w") as writer:
